(function () {
    ...
    var module = angular.module('Aeonium.services', [
        'ng.django.urls',
        'Aeonium.bootstrap',
        'ngSanitize'
    ]);
    ...
    module.factory('Aeonium.services.Feature', [
        '$http', 'djangoUrl',
    ...
    module.factory('Aeonium.services.Message', [
        '$http', 'djangoUrl', '$rootScope',
        'Aeonium.services.Code',
        'Aeonium.services.Progress',
    ...
    module.factory('Aeonium.services.Code', [
        '$http', 'djangoUrl', '$rootScope',
    ...
    module.factory('Aeonium.services.Progress', [
        '$http', 'djangoUrl', '$rootScope',
    ...
    module.factory('Aeonium.services.ActionHistory', [
