...
api_root_urls = {
    ...
    'story': url(r'^story/(?P<story_id>[0-9]+)$', csrf_exempt(views.StoryView.as_view()), name='story'),
    ...
    'code_stories': url(r'^code_stories/$', csrf_exempt(views.CodeStoryView.as_view()), name='code_stories'),
    'some_stories': url(r'^some_stories/$', csrf_exempt(views.SomeStoryView.as_view()), name='some_stories'),
    'all_coded_stories': url(r'^all_coded_stories/$', csrf_exempt(views.AllCodedStoryView.as_view()), name='all_coded_stories'),
